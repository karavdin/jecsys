{
  ...
  // compareJECversions("AK4PF",false,false,false,true,"MC"); // L1RC
  // compareJECversions("AK8PFchs",false,false,false,true,"MC"); // L1RC
  // compareJECversions("AK8PF",false,false,false,true,"MC"); // L1RC
 ...
 // //  // // Test DATA
 //  /*  compareJECversions("AK5PF",true,true,false,false,"DATA"); // L1L2L3  
 //  compareJECversions("AK5PF",false,true,false,false,"DATA"); // L2L3  
 //  compareJECversions("AK5PF",true,true,true,false,"DATA"); // L1L2L3+Res
 //  compareJECversions("AK5PF",false,false,true,false,"DATA"); // L2L3Res
 //  compareJECversions("AK7PF",true,true,false,false,"DATA"); // L1L2L3  
 //  compareJECversions("AK7PF",false,true,false,false,"DATA"); // L2L3  
 //  compareJECversions("AK7PF",true,true,true,false,"DATA"); // L1L2L3+Res
 //  compareJECversions("AK7PF",false,false,true,false,"DATA"); // L2L3Res
 //  compareJECversions("AK5PF",true,false,false,false,"DATA"); // L1FastJet
 //  compareJECversions("AK7PF",true,false,false,false,"DATA"); // L1FastJet
 //  */

  // compareJECversions("AK4PF",false,false,false,true,"DATA"); // L1RC
  ...
  // compareJECversions("AK4PFPuppi",true,false,false,false,"DATA"); // L1FastJet
  ...
  // compareJECversions("AK8PFchs",false,false,false,true,"DATA"); // L1RC
  ...
  // compareJECversions("AK8PFchs",false,false,true,false,"DATA"); // L2L3Res

  // compareJECversions("AK8PFPuppi",true,false,false,false,"DATA"); // L1FastJet
  ...
  // compareJECversions("AK8PFPuppi",false,false,true,false,"DATA"); // L2L3Res

  // compareJECversions("AK8PF",false,false,false,true,"DATA"); // L1RC
  ...
  // compareJECversions("AK8PF",false,false,true,false,"DATA"); // L2L3Res
  ...
  // compareJECversions("AK4PF",false,false,true,false,"DATA"); // L2L3Res
