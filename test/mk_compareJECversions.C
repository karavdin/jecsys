{
  ...
  // compareJECversions("AK5PF",true,false,false,false,"MC"); // L1
  // compareJECversions("AK5PF",false,true,false,false,"MC"); // L2L3
  // compareJECversions("AK5PF",true,true,false,false,"MC"); // L1L2L3
  
  // compareJECversions("AK7PF",true,false,false,false,"MC"); // L1
  // compareJECversions("AK7PF",false,true,false,false,"MC"); // L2L3
  // compareJECversions("AK7PF",true,true,false,false,"MC"); // L1L2L3
