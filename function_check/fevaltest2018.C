...
void fevaltest2018() {
  ...
  TString formula = "max(0.0001,1-(z/y)*([0]+[1]*(x-20.s0)+[2]*log(y/30.0)+[3]*pow(log(y/30.0),2)+[4]*(x-20.0)*log(y/30.0)+[5]*(x-20.0)*pow(log(y/30.0),2)))";//Fall17_17Nov2017_VX
  ...
  //legend->SetHeader("Fall17_17Nov2017_V20");
    legend->SetHeader("Fall17_17Nov2017_VX");
  ...
  float fe = mFunc.evaluate(reco::formula::ArrayAdaptor(x,6), reco::formula::ArrayAdaptor(par,6) );
